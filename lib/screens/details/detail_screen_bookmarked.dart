...
class DetailScreenBookmarked extends StatefulWidget {
  final String? title;
  final String? author;
  ...
  const DetailScreenBookmarked(this.title, this.author, this.content, this.url,
      this.urlToImage, this.publishedAt, this.category,
      {super.key});

  @override
  State<DetailScreenBookmarked> createState() => _DetailScreenBookmarkedState();
}

class _DetailScreenBookmarkedState extends State<DetailScreenBookmarked> {
